...
const props = defineProps({
  ...
  beamsPerSide: { type: Number, required: false, default: 3 },
  beamSize: { type: Number, required: false, default: 5 },
  beamDelayMax: { type: Number, required: false, default: 3 },
  beamDelayMin: { type: Number, required: false, default: 0 },
  beamDuration: { type: Number, required: false, default: 3 },
  gridColor: { type: String, required: false, default: 'hsl(var(--border))' },
